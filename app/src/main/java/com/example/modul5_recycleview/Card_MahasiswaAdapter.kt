...
class Card_MahasiswaAdapter(private val context: Context, private val dataList: List<Inis_Variable>, val listener: (Inis_Variable) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType:
    Int): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.card_mahasiswalayout, parent, false)
